import 'package:code/biz_design/id_a/id_a_2/exp_screen.dart';
import 'package:code/biz_design/id_a/id_a_3/bloc/login1.bloc.dart';
...
import 'package:code/biz_design/id_a/id_a_4/login2.dart';
      ...
      body: BlocConsumer<Login1Bloc, Login1State>(
        ...
        listener: (context, state){
          if(state is Login1NavigateLogin2State){
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context) => const ExpScreen()));
          }
        },
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text('無料アカウントを作成',style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w700
                          ),),
                        ),
                    ...
                    Positioned(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text('アカウントをお持ちの方はこちら',style: TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w700
                          ),),
                        ),
